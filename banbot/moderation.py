"""Ban, temporary ban, unban, admin protection, and room ban application logic."""
...
class ModerationMixin:
    ...
    async def is_protected_admin_target(
        ...
        """
        Return (True, reason) if the target would ban an owner/admin in any protected room
        or the admin room.
        """
