...
class ConfigSnapshotMixin(_ConfigSnapshotMixinContract):
    ...
    def _runtime_config_snapshot(self) -> dict[str, object]:
        ...
        return {
            ...
            "OUTBOX_ENABLED": getattr(self, "outbox_enabled", True),
            "OUTBOX_RETRY_INITIAL_SECONDS": getattr(self, "outbox_retry_initial_seconds", 30),
            "OUTBOX_RETRY_MAX_SECONDS": getattr(self, "outbox_retry_max_seconds", 1800),
            "OUTBOX_MAX_ATTEMPTS": getattr(self, "outbox_max_attempts", 12),
            "OUTBOX_BATCH_SIZE": getattr(self, "outbox_batch_size", 20),
            "OUTBOX_POLL_SECONDS": getattr(self, "outbox_poll_seconds", 5),
            "OUTBOX_MAX_PENDING": getattr(self, "outbox_max_pending", 10000),
            "OUTBOX_MAX_BYTES": getattr(self, "outbox_max_bytes", 50 * 1024 * 1024),
            "OUTBOX_MAX_PER_DESTINATION": getattr(self, "outbox_max_per_destination", 1000),
            "OUTBOX_MAX_PER_CATEGORY": getattr(self, "outbox_max_per_category", 5000),
    ...
    def _startup_config_snapshot(self) -> dict[str, object]:
        ...
        return {
            ...
            "WATCHDOG_ENABLED": getattr(config, "WATCHDOG_ENABLED", True),
            "WATCHDOG_INTERVAL_SECONDS": getattr(config, "WATCHDOG_INTERVAL_SECONDS", 20),
            "WATCHDOG_LAG_WARNING_SECONDS": getattr(config, "WATCHDOG_LAG_WARNING_SECONDS", 2.0),
            "WATCHDOG_LAG_FAILURE_SECONDS": getattr(config, "WATCHDOG_LAG_FAILURE_SECONDS", 30.0),
